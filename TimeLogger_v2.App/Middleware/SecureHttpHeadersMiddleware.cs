    ...
    public class SecureHttpHeadersMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            context.Response.OnStarting(() =>
            {
                ...
                context.Response.Headers.Add(HeaderNames.ContentSecurityPolicy, "default-src 'self'; img-src 'self'; object-src 'none'; script-src 'self' 'unsafe-eval' https://cdn.jsdelivr.net https://unpkg.com; style-src 'self' https://stackpath.bootstrapcdn.com; frame-ancestors 'self'; base-uri 'self'; form-action 'self'");
