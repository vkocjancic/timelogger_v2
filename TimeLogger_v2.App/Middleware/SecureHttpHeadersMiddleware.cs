    ...
    public class SecureHttpHeadersMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            context.Response.OnStarting(() =>
            {
                ...
                {
                    context.Response.Headers.Add(HeaderNames.AccessControlAllowOrigin, "timelogger.eu");
                }
                ...
                context.Response.Headers.Add(HeaderNames.ContentSecurityPolicy, "default-src 'self' https://v2.timelogger.eu https://cdnjs.cloudflare.com; img-src 'self' data:; object-src 'none'; script-src 'self' 'unsafe-eval' https://v2.timelogger.eu https://cdn.jsdelivr.net https://unpkg.com; style-src 'self' https://v2.timelogger.eu https://cdnjs.cloudflare.com; frame-ancestors 'self'; base-uri 'self'; form-action 'self'");
                ...
                context.Response.Headers.Add(HeaderNames.StrictTransportSecurity, "max-age=10886400; includeSubDomains");
